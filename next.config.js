...
const nextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_LONGDO_MAP_KEY: publicEnv.NEXT_PUBLIC_LONGDO_MAP_KEY ?? publicEnv.VITE_LONGDO_MAP_KEY ?? process.env.NEXT_PUBLIC_LONGDO_MAP_KEY ?? process.env.VITE_LONGDO_MAP_KEY,
  },
  images: {
    remotePatterns: [
      {
